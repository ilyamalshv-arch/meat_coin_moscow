...
export default function ContactsSection() {
  return (
    <section className="-mx-4 border-b border-(--color-devider) px-4 pt-0 pb-5 md:-mx-20 md:border-none md:px-20 md:pt-16 md:pb-0">
      ...
      <ContactsDesktopSection />
      <OtherLocationsMobileSection />
    </section>
  );
}

function ContactsMobileSection() {
...
function ContactsDesktopSection() {
  return (
    <div className="hidden md:block">
      ...
      <div className="-mx-20 mb-30">
        <YandexMap className="h-119" />
      </div>
    </div>
  );
}

function OtherLocationsMobileSection() {
  return (
    <div className="md:hidden">
      {otherLocations.map((location) => (
        <div key={location.city} className="mb-8 last:mb-0">
          <H3Title className="mb-4 text-[24px] text-(--color-accent) underline">
            {location.city}
          </H3Title>
          <Paragraph className="mb-4">{location.address}</Paragraph>
          <ContactLinks />
        </div>
      ))}
    </div>
